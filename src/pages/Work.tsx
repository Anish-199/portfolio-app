...
const Work = () => {
  const allProjects = [
    ...
    },
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1574259392081-dbe3c19cd15e?q=80&w=1771&auto=format&fit=crop',
      category: 'mobile',
    },
    {
      id: 'project-6',
      title: 'Restaurant Booking System',
      description: 'A reservation system for restaurants with real-time availability updates.',
      tags: ['React', 'Node.js', 'MongoDB'],
      imageUrl: 'https://images.unsplash.com/photo-1590846406792-0adc7f938f1d?q=80&w=1772&auto=format&fit=crop',
      category: 'web',
    },
  ];
